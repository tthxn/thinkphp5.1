...
class Token
{
	...
	public static $accessTokenPrefix = 'accessToken_';//access_token前缀
	public static $refreshAccessTokenPrefix = 'refreshAccessToken_';//refresh_access_token前缀
	public static $expires = 7200;//token过期时间 2小时
	public static $refreshExpires = 60*60*24*30;   //刷新token过期时间,30天过期
	/**
    ...
    {
        //生成AccessToken，（tsr_shuffle表示随机打乱字符串中的所有字符）
